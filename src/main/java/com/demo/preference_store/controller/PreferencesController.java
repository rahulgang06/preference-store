...
public class PreferencesController {
    ...
    @PutMapping("/")
    public PreferenceResponse update(@RequestBody CreatePreferenceRequest request,int schemaVersion) {
        return preferencesMgmtService.updatePreference(request,schemaVersion);
    }
}
